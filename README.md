...
`Lily58 Base.ai`, `Lily58 Switch.ai`, `Lily58 Wall.ai`- with M3 screw&standoff holes and removed oled window\
`Lily58 revision2 - without oled window.ai`- Removed oled/mcu window's screw holes
